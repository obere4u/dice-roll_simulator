...
function rolledDice() {
    let rollResult = Math.floor(Math.random() * 6) + 1; //creates a random number between 1 and 6, the Math.random() * 6 will generate a random number from 0 to 5 and 1 will be added to it.
